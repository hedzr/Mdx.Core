...
namespace HzNS.MdxLib.MDict
{
    ...
    public partial class MDictLoader : Loader
    {
        public MDictLoader()
        {
        }
        ...
        private MDictKwIndexTables _seg1;
        ...
        public override MDictKwIndexTables DictKwIndexTables
        {
            get => _seg1;
            set => _seg1 = value;
        }
        ...
        private void LoadKwIndex1Table(Stream fs, string fsName)
        {
            ...
            if (DictHeader.GeneratedByEngineVersion == "2.0")
            {
                ...
                _seg1 = null;
                _seg1 = new MDictKwIndexTables {IndexesRawData = new List<byte>()};
